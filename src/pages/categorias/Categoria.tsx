...
function Categories() {
  ...
  const [idCategoriaDelete, setIdCategoriaDelete] = useState<number | null>(
    null
  );
        ...
        <div className="flex-1 overflow-auto p-8">
          ...
          <div className="grid grid-cols-3 gap-6 mt-8">
            <MetricCard
              ...
              value={
                (resumen as PropResumenCategoria[])[0]?.total_categorias || 0
              }
              color="red"
            >
            ...
            <MetricCard
              ...
              value={
                (resumen as PropResumenCategoria[])[0]?.total_productos || 0
              }
              color="green"
            >
            ...
            <MetricCard
              ...
              value={
                (resumen as PropResumenCategoria[])[0]?.promedio_categoria || 0
              }
              color="blue"
            >
